...
const AssetEdit = () => {
    ...
    useEffect(() => {
        axios
            ...
            .then((response) => {
                ...
                setSubSection(res.subSection);
                setComputerID(res.computerID);
                setUsername(res.username);
                setMobileno(res.mobileno);
                setOutdated(res.outdated);
                setComputerName(res.computerName);
                setIPaddress(res.IPaddress);
                setInternetAccess(res.internetAccess);
                setMACaddress(res.MACaddress);
                setOs(res.os);
                setOsVersion(res.osVersion);
                setOsBuild(res.osBuild);
                setOsActivationStatus(res.osActivationStatus);
                setMSofficeVersion(res.MSofficeVersion);
                setMSofficeActivationStatus(res.MSofficeActivationStatus);
                setMonitorModel(res.monitorModel);
                setMonitorSerialno(res.monitorSerialno);
                setMonitorStatus(res.monitorStatus);
                setCpuModel(res.cpuModel);
                setCpuSerialno(res.cpuSerialno);
                setCpuStatus(res.cpuStatus);
                setRAM(res.RAM);
                setHardDisk(res.hardDisk);
                setProcessor(res.processor);
                setSystemInstallDate(res.systemInstallDate);
                setSystemWarrantyStatus(res.systemWarrantyStatus);
                setAntiVirus(res.antiVirus);
                setPrinterModel(res.printerModel);
                setPrinterSerialno(res.printerSerialno);
                setScannerModel(res.scannerModel);
                setScannerSerialno(res.scannerSerialno);
                setScannerStatus(res.scannerStatus);
                setUpsMake(res.upsMake);
                setUpsCapacity(res.upsCapacity);
                setUpsSerialno(res.upsSerialno);
                setUpsStatus(res.upsStatus);
            })
            .catch((error) => {
                console.log(error);
    ...
    const handleSaveBook = () => {
        ...
        axios
            .put(`http://localhost:5000/asset/edit/${id}`, data)
            .then(() => {
        ...
        <div >
            ...
            <div className='container'>
                ...
                <main className='content'>
                    <div className='back' onClick={cancel}><a>Back</a></div>
                    <h1>Edit Asset</h1>
                    <div>
